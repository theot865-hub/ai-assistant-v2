...
ARTIFACTS_BY_WORKER: dict[str, list[str]] = {
    ...
    "pipeline": [
        "workspace/leads/all_realtor_leads.csv",
        "workspace/jobs/latest_research.txt",
        "workspace/leads/all_realtor_outreach.csv",
        "workspace/leads/all_realtor_leads_enriched.csv",
    ],
}
